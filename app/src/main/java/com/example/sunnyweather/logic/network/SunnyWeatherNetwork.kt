...
object SunnyWeatherNetwork {
    ...
    suspend fun searchRealtimeWeather(lat: Double, lng: Double) = weatherService.getRealtimeWeather(lat,lng).await()

    suspend fun searchDailyWeather(lat: Double, lng: Double) = weatherService.getDailyWeather(lat, lng).await()
